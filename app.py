...
def result_for_score_v2(total: int) -> tuple[str, str, str]:
    ...
    if 11 <= total <= 21:
        title = "Homo sapiens"
    text = (
        "It's quite natural for people to feel a bit down during the winter months. You are a bit affected by winter blues. "
        "It is overwhelming for you to do hard things, but you still do them, just with more effort.\n\n"
        "**Tips:**\n"
        "- For all homo sapiens sleep schedule is really important. That is why you should be mindful with it. "
        "**Why it helps**: In winter, the reduced sunlight can scramble your internal clock. A consistent schedule, especially a fixed wake-up time, "
        "acts like an anchor, syncing your circadian rhythm with the outside world. "
        "**First tiny step**: Make yourself a schedule of when you would like to go to bed and when to wake up every day.\n"
        "- As a Homo sapiens, your mind is your greatest survival tool, but in winter, it can turn into a battlefield of worrying thoughts. "
        "**Why it helps**: To start a journal means to let your thoughts flow freely and connect with your inner self. "
        "Writing down one's thoughts helps a person to understand and see their inner intentions and deep desires, which leads to a better overall understanding of their own life. "
        "**First tiny step**: Place a notebook near your bed. Don't write anything yet. Just create the possibility.\n"
    )
    ...
    if 22 <= total <= 28:
        ...
        text = (
        "You still stand, but your leaves fall during the colder months. You are affected by winter blues. "
        "It can get pretty rough for you during winter; sometimes you resist winter blues, but it still gets you.\n\n"
        "**Tips:**\n"
        "- Your energy is conserved inward, like a dormant tree. To gently signal for spring, send out one small \"root\" by researching one local club or online community "
        "related to your hobbies (e.g., book club, language exchange). "
        "**Why it helps**: Trees need each other to survive, which is why joining a club will stand you in good stead. "
        "By connecting with others through hobbies, you keep your energy up and follow your interests. "
        "**First tiny step**: Research what clubs are available and reach out to them.\n"
        "- Just like a tree shedding its leaves to conserve energy, you need to get rid of the excessive use of social media to lower your stress levels. "
        "**Why it helps**: The constant stream of stressful news and comparison-driven social media drains your vital resources and casts a shadow over your already low light. "
        "Reducing time online reduces the cognitive and emotional \"noise,\" making space for quieter thoughts. "
        "**First tiny step**: Set a time limit on your phone or find activities apart from social media.\n"
)
